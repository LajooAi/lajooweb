...
export const INSURANCE_KNOWLEDGE_BASE = [
  ...
  // Road Tax
  {
    ...
    answer: "**Ways to renew road tax in Malaysia:**\n\n**1. Online (via LAJOO / MyJPJ / MyEG):**\n- Fastest method, digital road tax updates immediately\n- Need valid insurance first\n\n**2. JPJ or Pos Malaysia counter services:**\n- Counter renewal is available at selected branches\n- Bring required identification and supporting documents\n\n**Printed road tax policy (effective 1 Feb 2026):**\n- Printed road tax is only for vehicles registered under a **Foreign ID** or **Company Registration**\n- Individual-owned vehicles should use digital road tax (MyJPJ)\n\n**Important:** Insurance must be valid before road tax can be renewed.",
  ...
  },
  {
    ...
    answer: "**Yes. Digital road tax (e-road tax) is legal and accepted nationwide in Malaysia.**\n\n**Digital Road Tax:**\n- Stored in MyJPJ app\n- No physical sticker needed\n- Instant update after renewal\n- Same legal validity for enforcement checks\n\n**Printed Road Tax (effective 1 Feb 2026):**\n- Only available for vehicles registered under **Foreign ID** or **Company Registration**\n- Not available for individual-owned vehicles\n\n**Police/JPJ checks:**\nEnforcement can verify status directly in the system using your vehicle registration number.\n\n**Recommendation:** Use digital road tax for the fastest and standard renewal flow.",
  ...
  },
  {
    ...
    answer: "**Betterment** is the depreciation portion you pay when old damaged parts are replaced with brand-new parts in an own-damage claim.\n\n**If no waiver is added (standard schedule):**\n- Vehicle below 5 years: **0%**\n- 5 years: **15%**\n- 6 years: **20%**\n- 7 years: **25%**\n- 8 years: **30%**\n- 9 years: **35%**\n- 10 years and above: **40%**\n\n**Quick insurer view (Malaysia):**\n- **Allianz:** Waiver is available via endorsement (A201) if included in policy schedule and extra premium paid. Endorsement text does not state a fixed max car age.\n- **Etiqa:** \"New Spare Part Replacement Cover\" waives betterment for eligible cars **5 to 15 years** old (from year of manufacture), when this cover is purchased.\n- **Takaful Ikhlas:** \"Waiver of Betterment Contributions\" (MTD007A) waives betterment for eligible cars **up to 15 years** old (from year of manufacture), when purchased.\n\nIf waiver/endorsement is not in your schedule, standard betterment percentages apply.",
    keywords: ["betterment", "betterment charges", "claim deduction", "depreciation", "zero betterment", "waiver of betterment", "allianz betterment", "etiqa betterment", "takaful ikhlas betterment"]
  },
  {
    id: "zero-betterment-by-insurer",
    category: "Claims",
    question: "Do the available insurers include zero betterment?",
    answer: "**Short answer:** zero betterment is usually **not automatic** in base cover. It depends on whether the waiver/add-on endorsement is purchased and listed in your schedule.\n\n**Allianz**\n- Waiver available: **Yes** (A201 Waiver of Betterment)\n- Included by default: **No**, unless endorsement is in schedule\n- Car age rule in endorsement wording: **No fixed age limit stated** (eligibility can still depend on underwriting/product terms)\n\n**Etiqa**\n- Waiver available: **Yes** (New Spare Part Replacement Cover)\n- Included by default: **No**, needs additional premium\n- Car age rule: **5 to 15 years** from year of manufacture\n\n**Takaful Ikhlas**\n- Waiver available: **Yes** (MTD007A Waiver of Betterment Contributions, Comprehensive Plus wording)\n- Included by default: **No**, needs additional contribution and schedule endorsement\n- Car age rule: **Not more than 15 years** from year of manufacture\n\nFor **Tokio Marine, Lonpac, MSIG, and Generali**, no verified zero-betterment fact is currently loaded in this static knowledge base. If waiver is not included, standard betterment applies by age: 5y 15%, 6y 20%, 7y 25%, 8y 30%, 9y 35%, 10y+ 40%.",
    keywords: ["zero betterment", "waiver of betterment", "allianz", "etiqa", "takaful ikhlas", "tokio marine", "lonpac", "msig", "generali", "a201", "mtd007a", "new spare part replacement", "betterment percentage", "car age betterment"]
  },
  {
