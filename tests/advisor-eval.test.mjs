...
const advisorEvalCases = [
  ...
  },
  {
    ...
    response: [
      /A 10% direct discount can exist/i,
      /headline discount is not the full renewal decision/i,
      /With \*\*LAJOO\*\*/i,
      /guided quote comparison, add-on advice, road tax handling, and a cleaner renewal flow/i,
      /Let’s continue with LAJOO/i,
    ],
    responseNot: [/saving matters/i, /consider it/i, /compare (?:the )?direct offer/i, /apples-to-apples/i, /Tokio Marine Insurance - RM 800.00/i, /Takaful Ikhlas Insurance - RM 796.00/i, /Back to your renewal/i],
  },
  {
  ...
  },
  {
    ...
    state: quoteState,
    advisorIntent: ADVISOR_INTENTS.QUOTE_EXPLORATION,
    rawIntent: USER_INTENTS.ASK_QUESTION,
    decisionMode: CONVERSATION_MODES.QUOTE_COMPARISON,
  ...
  {
    name: 'daily driving context recommends windscreen first instead of menu-only close',
    message: 'i drive my car a lot daily',
    state: addOnsState,
    advisorIntent: ADVISOR_INTENTS.COVERAGE_RISK_ADVICE,
    topic: ADVISOR_TOPICS.DAILY_DRIVING,
    decisionMode: CONVERSATION_MODES.INSURANCE_QUESTION,
    response: [/Since you drive a lot daily/i, /start with 1\. Windscreen/i, /stone chips|road debris/i, /7-year-old Perodua Myvi/i, /Special Perils/i, /flood or landslide/i, /RM 1,000.00/i, /RM 2,000.00/i],
    responseNot: [/Since you drive daily, would you like/i, /Windscreen, Special Perils, E-hailing, or skip add-ons/i, /What windscreen coverage should I use/i],
  },
  {
  ...
  },
  {
    ...
    response: [/RM 1,000.00 cover/i, /sensible starting cover/i, /RM 2,000/i],
  },
  {
